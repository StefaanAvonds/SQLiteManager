...
using SQLiteManager.Windows.Extensions;
...
[assembly: Dependency(typeof(DatabaseFileWindows))]
namespace SQLiteManager.Windows.FileSystem
{
    public class DatabaseFileWindows : IDatabaseFile
    {
